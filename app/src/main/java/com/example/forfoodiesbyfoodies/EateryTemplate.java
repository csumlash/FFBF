...
public class EateryTemplate implements Parcelable {
    ...
    // The default Constructor that is requested by the Parcelable and Database
    ...
    // This method is required by the implemented Parcelable class for object transfer with Intents
    @Override
